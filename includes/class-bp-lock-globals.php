...
class Bp_Lock_Globals {
	 ...
	 * @access   public
	 *
	 * @var      array  $custom_form_content
	 */
	public $custom_form_content;
	 ...
	 * @param int    $version Version of Plugin.
	 */
	...
	public function copy_plugin_globals_to_option() {
		...
		if ( ! $bplock_gen_globals_copied && 'copied' != $bplock_gen_globals_copied ) {
		...
		if ( ! $plugin_default && 'bplock-default' != $plugin_default ) {
