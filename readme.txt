...
Tags: BuddyPress, lock, privacy, restrict access, private BuddyPress, BuddyPress Intranet, BuddyPress Members only
...
BuddyPress Private Community allows the site owner to lock the different BuddyPress components on the site for non-logged-in users and gives options to lockdown pages.

== Description ==

BuddyPress Private Community allows the administrator to lock certain parts of their site. It helps create a private BuddyPress community by locking certain BuddyPress Components and WordPress Pages for public view without using any membership plugin. You can set the locked content, which will be displayed on the locked page.
The user will need to log in/register to view the locked content.
...
This plugin does not require any specific plugin. However, it supports BuddyPress if it is active.

= What does this plugin do? =
This plugin allows the site administrator to secure components of BuddyPress (if active) and WordPress pages from non-logged-in users. You can lock down WordPress Pages and any BuddyPress Component. It also allows you to display content like shortcodes or simple messages.

= What happens if the user enables the "Restrict BuddyPress Components" option? =
If the "Restrict BuddyPress Components" option is enabled, logged-out users will not be able to access BuddyPress components. The admin can set content to be displayed on the restricted pages.

= What happens if the user enables the "Restrict WordPress Pages" option? =
If the "Restrict WordPress Pages" option is enabled, access to WordPress pages will be restricted for logged-out users. The admin can set content to be displayed on the restricted pages.

= What is the Custom Restriction Message? =
The Custom Restriction Message is a message the admin sets that will be displayed on protected pages when access is restricted.

= How can the Login and Registration Form be displayed? =
You can display a plugin-specific message or add third-party shortcodes for login and registration forms on the protected pages.

== Screenshots ==

1. This screenshot shows the plugin general settings to screenshot-1.(png|jpg|jpeg|gif).
2. This screenshot shows the BuddyPress Component options setting to screenshot-2.(png|jpg|jpeg|gif).
4. This screenshot shows the page List options setting to screenshot-4.(png|jpg|jpeg|gif).
5. This screenshot shows the locked pages setting the layout to screenshot-5.(png|jpg|jpeg|gif).
