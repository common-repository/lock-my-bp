jQuery(document).ready(function($) {
	...
	$(document).on('click', '.wbcom-faq-accordion', function() {
		return false;
	});
	...
	$('.lr-form').click(function() {
		...
		if (option == 'custom_form') {
			$('.custom_form').show();
			$('#wp-bplock-locked-content-wrap, #wp-bplock-locked-content-wrap-view').closest("div").show();
			$('#logout_redirect_page').hide();
		} else if (option == 'page_redirect') {
			$('#logout_redirect_page').show();
			$('.custom_form').hide();
			$('#wp-bplock-locked-content-wrap, #wp-bplock-locked-content-wrap-view').closest("div").hide();
		} else {
			$('#wp-bplock-locked-content-wrap, #wp-bplock-locked-content-wrap-view').closest("div").show();
			$('.custom_form').hide();
			$('#logout_redirect_page').hide();
